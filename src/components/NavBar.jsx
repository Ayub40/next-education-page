        ...
        <div className='mx-auto '>
            <div className="container flex flex-col lg:flex-row py-2 justify-between items-center">
                ...
                <div className="flex gap-2 items-center border border-[#d0d5dd] px-0.5 pl-2 py-0.5 rounded-md" >
                    ...
                    <button className='flex items-center px-3 py-1 font-medium text-purple-600 capitalize rounded-md bg-[#F3E8FF] hover:bg-[#A855F7] hover:text-white'>Explore
                        <BsArrowDownShort />
                    </button>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <p className='text-base text-[#A855F7] hover:text-white font-medium capitalize bg-[#F3E8FF] hover:bg-[#A855F7] border border-none cursor-pointer btn btn-sm'>Create Free Account</p>
