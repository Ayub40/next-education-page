...
const Heros = () => {
    ...
    return (
        <div className="container mx-auto  py-10">
            <p className="text-lg text-[#2AA9BE] text-center font-medium">Tutors</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-12 py-10">
                {service.map((ser, i) => {
                    return (
                        <div
                            className="px-6 py-4 flex justify-center items-center flex-col rounded-xl bg-gray-50 shadow-lg border border-gray-200 hover:bg-[#2BAABE] group "
                            key={i}
                        >
                            ...
                            <p className="text-sm text-center text-[#2BAABE] group-hover:text-white capitalize py-2">
                                {ser.sub}
                            </p>
                            ...
                            <div className="flex gap-5 items-center">
                                <a href={ser.fb} >
                                    <BsFacebook className="text-[#2BAABE] group-hover:text-white" />
                                </a>

                                <a href={ser.twitter}>
                                    <AiFillLinkedin className="text-[#2BAABE] group-hover:text-white" />
                                </a>
                            </div>
                        </div>
                    );
